...
class AdditiveInputTransition(Transition):
    def __init__(
        self,
        dz,
        du,
        ...
        super(AdditiveInputTransition, self).__init__(dz, 
                         du, 
                         hidden_dim,
                         nonlinearity, 
                         exp_par, 
    ...
    def forward(self, z, s, u=None):
        ...
        # transform neuromodulator signals into an additive constant 
        neuromodulation = s @ self.nm_params

        R = self.get_rates(z, u=u, nm=neuromodulation.flatten(), additive=True)    
